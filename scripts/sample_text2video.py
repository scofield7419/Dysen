...
from vdm.utils.common_utils import str2bool
from vdm.utils.dist_utils import setup_dist, gather_data
...
def get_parser():
    ...
    parser.add_argument("--ddim_steps", type=int, help="ddim sampling -- number of ddim denoising timesteps", default=100)
